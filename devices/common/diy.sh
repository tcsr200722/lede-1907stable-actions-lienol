...
git clone https://github.com/ledewrt/luci-app-ledeproxy-old.git package/diy/luci-app-ledeproxy
#git clone https://github.com/ledewrt/luci-app-koolproxyR.git package/diy/luci-app-koolproxyR
#git clone https://github.com/Beginner-Go/luci-app-koolproxyR package/diy/luci-app-koolproxyR
